...
Now the [`code`](https://github.com/souvik0306/computer-vision/blob/master/Face%20Detection/Face%20Detection%20over%20Image.py) is capable to iterating over all the images in a directory, saving a lot of time, and prints a subsequent match-percentage as well.
